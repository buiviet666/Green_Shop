        ...
        <div id="single-product">
            <div class="containers p_b5">
                <div class="flex-wrap">
                    ...
                    <div class="single-imgall w-max p_l-r m_t5 m_b5 media-w100">
                        <!-- 1.1 ảnh to bên trên -->
                    ...
                    <div class="single-textall w-max p_l-r m_t5 m_b5 media-w100">
                        <div class="single-product_container_textall">
                            <div class="single-product_setup_textall">
                                ...
                                <!-- 2.2 giá sản phẩm -->
                                <p class="h5 p_t-b m_b"><?php echo $each['price'] ?> ₫</p> <!-- lấy từ db về -->
                                ...
                                <ul class="n-list_style m_b2">
                                    <li class="d-inline m-r"><h6 class="h6 m_b">Nhãn hiệu:</h6></li>
